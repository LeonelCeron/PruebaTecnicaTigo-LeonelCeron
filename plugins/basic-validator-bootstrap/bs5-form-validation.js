...
class Validation
{
    ...
    */
    ...
    lengthCheck(input, minLength, maxLength)
    {
        ...
        else if (input.val().length < minLength)
        {
            return "No debe contener menos de " + minLength + " caracteres. ";
        }
        else if (input.val().length > maxLength)
        {
            return "No debe contener más de " + maxLength + " caracteres. ";
        }
        else
        {
            return "";
    ...
    illegalCharCheck(input, illegalCharArray)
    {
        ...
        {
            return "No debe usar:" + illegalsUsed + ". ";
        }
    }
